...
bot = TeleBot(token='5610773075:AAEAjoxstW0JXSnX-Y1yBs7Xo9N6oGiSZzo', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет человек! Я помогу тебе проверить JSON и форматирую его в красивый текст\nВведи JSON в виде строки:', # текст сообщения
    )
